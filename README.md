...
- [cdktn-aws-codebuild-gha-runners](https://github.com/garysassano/cdktn-aws-codebuild-gha-runners) - Built with CDKTN instead of AWS CDK.
- [cdktn-aws-codebuild-gha-runners-org](https://github.com/garysassano/cdktn-aws-codebuild-gha-runners-org) - Built with CDKTN instead of AWS CDK; uses a GitHub organization webhook instead of repository webhook.
